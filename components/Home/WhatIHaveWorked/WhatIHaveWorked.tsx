  ...
  return (
    <div className="flex flex-col items-center justify-center py-24 space-y-12">
      ...
      <section className="flex flex-row space-x-3 items-center px-2 md:px-0">
        ...
        <span className="text-gray-200 text-xl md:text-2xl">Where I&apos;ve Worked</span>
...
const CompaniesBar = props => {
  ...
  const [companyNameBackgroundColorGreen, setCompanyNameBackgroundColorGreen] = React.useState<boolean[]>([true,false,false,false])
  return (
    <>
      <div className="flex flex-col md:flex-row w-screen md:w-auto 
        ...
        <div className="flex flex-col md:order-2 order-1 space-y-2 pl-8 md:pl-0 ">
          ...
          <button
            onClick={() => {
              ...
              setCompanyNameBackgroundColorGreen([true,false,false,false]);
            }}
            className={`flex-none text-sm text-center md:text-left  hover:text-AAsecondary
             ...
             ${companyNameBackgroundColorGreen[0]? "bg-ResumeButtonHover text-AAsecondary": "text-gray-400"}`}
          >
            Google
          </button>
          <button
            onClick={() => {
              ...
              setCompanyNameBackgroundColorGreen([false,true,false,false]);
            }}
            className={`flex-none text-sm text-center md:text-left hover:text-AAsecondary
             hover:bg-ResumeButtonHover rounded font-mono
             md:py-2 md:pl-6 md:px-4 md:w-44 w-32 
             ${companyNameBackgroundColorGreen[1]? "bg-ResumeButtonHover text-AAsecondary": "text-gray-400"}`}
          >
            Facebook
          </button>
          <button
            onClick={() => {
              setBarPosition(70);
              setBarAbovePosition(257);
              setCompanyNameBackgroundColorGreen([false,false,true,false]);

            }}
            className={`flex-none text-sm text-center md:text-left hover:text-AAsecondary
            hover:bg-ResumeButtonHover rounded font-mono
            md:py-2 md:pl-6 md:px-4 md:w-44 w-32 
            ${companyNameBackgroundColorGreen[2]? "bg-ResumeButtonHover text-AAsecondary": "text-gray-400"}`}
          >
            Twitter
          </button>
          <button
            onClick={() => {
              setBarPosition(107);
              setBarAbovePosition(385);
              setCompanyNameBackgroundColorGreen[2]=true;
              setCompanyNameBackgroundColorGreen([false,false,false,true]);
            }}
            className={`flex-none text-sm text-center md:text-left hover:text-AAsecondary
            hover:bg-ResumeButtonHover rounded font-mono
            md:py-2 md:pl-6 md:px-4 md:w-44 w-32 
            ${companyNameBackgroundColorGreen[3]? "bg-ResumeButtonHover text-AAsecondary": "text-gray-400"}`}
          >
            Discord
          </button>
          </div>
