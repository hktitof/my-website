      ...
      <section className="flex flex-row ">
        ...
        <div className="flex flex-row space-x-4">
          ...
          <div className="relative h-96 w-0.5 bg-gray-500 rounded">
            {/* animated left bar */}
            <div ref={barRef} className={`absolute w-0.5 h-10 rounded bg-AAsecondary
            transition ${barCurrentPosition} duration-300`}></div>
          </div>
          {/* Companies name as buttons */}
          <div className="flex flex-col">
            <button onClick={()=>barTranslateY(0)} className="text-sm text-left hover:text-AAsecondary
             hover:bg-ResumeButtonHover rounded text-gray-400 font-mono  
             py-2 pl-6 px-4 w-44">
              Google
            </button>
            <button onClick={()=>barTranslateY(1)} className="text-sm text-left hover:text-AAsecondary
             hover:bg-ResumeButtonHover rounded text-gray-400 font-mono
              py-2 pl-6 px-4 w-44">
              Facebook
            </button>
