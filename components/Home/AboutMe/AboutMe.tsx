...
export default function AboutMe(props:{ref}) {
  return (
      <div id="aboutSection" ref={props.ref} data-aos="fade-up" className="snap-start flex flex-col  items-center py-20 bg-AAprimary">
        {/* // ? 0.1 About Me */}
        <div
            ...
            <div className="w-full md:w-7/12 space-y-4 sm:text-base text-sm ">
              <div className="font-Header ">
                <span className="text-gray-400  tracking-wide">
                  ...
                  <span className="text-AAsecondary">Ethical Hacking</span> using BackTrack OS — it turns out
              ...
              <div className="font-Header tracking-wide">
                <span className="text-gray-400  ">
                  ...
                  <span className="text-AAsecondary">export-import companies</span>, and recently as Lead for the{" "}
                ...
                <div className="flex flex-row space-x-2 items-center">
                  <div className="flex flex-col space-y-4 sm:text-base text-sm">
                    <div className="flex flex-row items-center space-x-2">
                      ...
                      <span className="text-gray-400 sm:text-sm text-xs">Solidity</span>
                    </div>
                    <div className="flex flex-row items-center space-x-2">
                      <ArrowIcon className={"h-3 w-3 text-AAsecondary"} />
                      <span className="text-gray-400 sm:text-sm text-xs">Next js</span>
                    </div>
                    <div className="flex flex-row items-center space-x-2">
                      <ArrowIcon className={"h-3 w-3 text-AAsecondary"} />
                      <span className="text-gray-400 sm:text-sm text-xs">JavaScript (ES6+)</span>
                    </div>
                    <div className="flex flex-row items-center space-x-2">
                      <ArrowIcon className={"h-3 w-3 text-AAsecondary"} />
                      <span className="text-gray-400 sm:text-sm text-xs">Tailwind CSS</span>
                    </div>
                  </div>
                </div>
                <div className="flex flex-row space-x-2 items-center">
                  <div className="flex flex-col space-y-4 sm:text-base text-sm">
                    <div className="flex flex-row items-center space-x-2">
                      <ArrowIcon className={"h-3 w-3 text-AAsecondary"} />
                      <span className="text-gray-400 sm:text-sm text-xs">Hardhat</span>
                    </div>
                    <div className="flex flex-row items-center space-x-2">
                      <ArrowIcon className={"h-3 w-3 text-AAsecondary"} />
                      <span className="text-gray-400 sm:text-sm text-xs">Node</span>
                    </div>
                    <div className="flex flex-row items-center space-x-2">
                      <ArrowIcon className={"h-3 w-3 text-AAsecondary"} />
                      <span className="text-gray-400 sm:text-sm text-xs">TypeScript</span>
                    </div>
                    <div className="flex flex-row items-center space-x-2">
                      <ArrowIcon className={"h-3 w-3 text-AAsecondary"} />
                      <span className="text-gray-400 sm:text-sm text-xs">Framer Motion</span>
                    </div>
                  </div>
                </div>
              </div>
