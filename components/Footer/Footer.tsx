...
export default function Fotter() {
  return (
    ...
    <div className="bg-AAprimary flex flex-col justify-center items-center py-8 space-y-8">
      ...
      <svg
            ...
            aria-hidden="true"
            role="img"
            className="w-6 h-6 text-gray-400 fill-current group-hover:text-AAsecondary"
            viewBox="0 0 24 24"
          >
  ...
  >
    ...
    >
      ...
      <span className="group-hover:text-AAsecondary">Designed & Built by Anaflous Abdellatif</span>
