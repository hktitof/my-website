...
const IconsData = [
  { href: "https://github.com/satyam04sharma", Icon: GithubIcon },
  { href: "https://www.linkedin.com/in/satyam-sharma-26a08311a/", Icon: LinkedinIcon },
];
    ...
    text-sm  space-y-2  "
        >
          <span className="group-hover:text-AAsecondary sm:text-sm text-xs">
            Built by Satyam Sharma (Shoutout to @abdellatif_anaflous)
          </span>
