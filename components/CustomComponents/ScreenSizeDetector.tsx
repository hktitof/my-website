  ...
  return (
    ...
    >
      <div className="h-6 w-8 rounded-r-md bg-yellow-300 flex justify-center items-center text-black font-bold text-xs p-1">
        <span className="3xl:block 2xl:hidden xl:hidden lg:hidden md:hidden sm:hidden hidden">4XL</span>
        <span className="2xl:block xl:hidden lg:hidden md:hidden sm:hidden hidden">3XL</span>
